...
from internal_op.models import Test1
...
def save_data(request):
    ...
    try:
        ...
        raw_text_data = request.POST.get("text_data")
        files = request.FILES
        results = []
        ...
        liquid_photo_path = handle_uploaded_file(liquid_file,
                                                 new_name=f"{new_data.pk}_liquid") if liquid_file else "未上传"
